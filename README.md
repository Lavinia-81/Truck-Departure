...
The application is structured into two key components, each with a specific role in the logistics ecosystem.
...
*   **Data Storage:** **Firebase Firestore** - A scalable and real-time NoSQL database for persisting all departure data.
*   **UI & Styling:**
